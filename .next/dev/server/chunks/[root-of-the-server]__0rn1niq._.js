...
async function POST(request) {
    ...
    try {
        ...
        // Temporary image
        imagePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "temp-plant-image.jpg");
        await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["writeFile"])(imagePath, imageBuffer);
        // Path to medicinal_plant_model
        const modelDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "..", "..", "medicinal_plant_model");
        const pythonScript = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(modelDir, "predict.py");
        ...
        const plantName = result.plant;
        /*
     * Find matching plant in plants.json
     *
     * Handles small differences such as:
     * Tulasi
     * tulasi
     * TULASI
     */ const plantData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$2f$plants$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find((plant)=>plant.name?.toLowerCase() === plantName?.toLowerCase());
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            plant: plantName,
            confidence: result.confidence,
            properties: plantData?.properties || "No plant information available.",
        ...
        if (imagePath) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["unlink"])(imagePath);
            } catch  {}
        }
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0rn1niq._.js.map